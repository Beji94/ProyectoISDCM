...
/**
 * Jersey REST client generated for REST resource:VideosFacadeREST
 * [entidades.videos]<br>
 * USAGE:
 * <pre>
 *        VideoJerseyClient client = new VideoJerseyClient();
 ...
 * @author Beñat
 */
public class VideoJerseyClient {

    private WebResource webResource;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/Prueba_ServerRest/webresources";

    public VideoJerseyClient() {
        com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
        client = Client.create(config);
        webResource = client.resource(BASE_URI).path("entidades.videos");
    }

    public <T> T findbyurl_XML(Class<T> responseType, String url) throws UniformInterfaceException {
        WebResource resource = webResource;
        resource = resource.path("ruta");
        return resource.accept(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }

    public <T> T findbyurl_JSON(Class<T> responseType, String url) throws UniformInterfaceException {
        WebResource resource = webResource;
        resource = resource.path("ruta");
    ...
    /*public static void main(String args[])
    {
       ...
       // ClientResponse response1=new ClientResponse();
        ClientResponse response1= client1.findbyurl_XML(ClientResponse.class, "https://www.youtube.com/watch?v=CvixRV5DfXk");
